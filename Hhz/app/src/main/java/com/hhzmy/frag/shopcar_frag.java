...
public class shopcar_frag extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        SharedPreferences if_login = getActivity().getSharedPreferences("if_login", Context.MODE_PRIVATE);
        view = inflater.inflate(R.layout.shopcar_frag_layout, null, false);
        infoview();
        getCarData();
    ...
    class shop_lv_adapter extends BaseAdapter {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            final shop_lv_adapter.ViewHolder vh;
            if (convertView == null) {
                convertView = convertView.inflate(context, R.layout.shop_lv_item, null);
                vh = new shop_lv_adapter.ViewHolder();
                ...
                vh = (shop_lv_adapter.ViewHolder) convertView.getTag();
            }
