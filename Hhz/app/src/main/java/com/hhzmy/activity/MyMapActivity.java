...
public class MyMapActivity extends AppCompatActivity {
    ...
    private Button jing, wei, difang;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        difang = (Button) findViewById(R.id.di);
...
//            }
            ...
            if (list != null) {
                ...
                difang.setText(di.toString());
                Intent intent = new Intent();
                intent.putExtra("address", di.toString());
                // 设置结果，并进行传送
                MyMapActivity.this.setResult(0, intent);
            }
            Log.i("BaiduLocationApiDem", sb.toString());
            Toast.makeText(MyMapActivity.this, "经度:" + lotitude.toString() + "纬度:" + longitude.toString(), Toast.LENGTH_SHORT).show();
        }
    }
