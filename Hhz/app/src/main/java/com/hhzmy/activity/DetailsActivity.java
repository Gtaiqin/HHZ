...
import com.hhzmy.frag.details_det_frag;
import com.hhzmy.frag.details_goods_frag;
import com.hhzmy.frag.details_pl_frag;
...
public class DetailsActivity extends FragmentActivity implements View.OnClickListener {
    ...
    RelativeLayout immediatelyBuy;
    @BindView(R.id.add_shopcar)
    RelativeLayout addShopcar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        immediatelyBuy.setOnClickListener(this);
        servpadapter();
    }
    ...
    private void servpadapter() {
        details_vp_pager.setAdapter(new FragmentPagerAdapter(getSupportFragmentManager()) {
            ...
            public Fragment getItem(int position) {
                ...
                switch (position) {
                    case 0:
                        fragment = new details_goods_frag();
                        break;
                    case 1:
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.add_shopcar:
                Intent intent = new Intent(DetailsActivity.this, ShopCarActivity.class);
